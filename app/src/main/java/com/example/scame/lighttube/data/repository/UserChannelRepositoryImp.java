...
public class UserChannelRepositoryImp implements UserChannelRepository {
    ...
    public UserChannelRepositoryImp(ChannelsApi channelsApi, SharedPreferences sharedPrefs, Context context) {
    ...
    // TODO: check it
    // not sure if an account can contain only one channel
