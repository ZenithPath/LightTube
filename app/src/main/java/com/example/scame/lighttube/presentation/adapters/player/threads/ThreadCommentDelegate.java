...
public class ThreadCommentDelegate implements AdapterDelegate<List<ThreadCommentModel>> {
    ...
    public ThreadCommentDelegate(CommentActionListener actionListener, String identifier) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        return new ThreadCommentHolder(itemView, actionListener, identifier);
    }
    ...
    public int getViewType() {
        return CommentsDelegatesManager.VIEW_TYPE_THREAD_COMMENT;
    }
}
