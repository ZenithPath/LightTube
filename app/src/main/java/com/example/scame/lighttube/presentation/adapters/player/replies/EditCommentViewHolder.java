...
public class EditCommentViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindCommentEditorHolder(String commentText, String commentId) {
        ...
        commentInput.setOnEditorActionListener((v, actionId, event) -> {
            ...
            if (actionId == EditorInfo.IME_ACTION_SEND) {
                commentActionListener.onSendEditedClick(commentInput.getText().toString(), commentId);
                handled = true;
            }
