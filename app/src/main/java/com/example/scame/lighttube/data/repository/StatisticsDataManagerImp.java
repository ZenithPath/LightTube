...
public class StatisticsDataManagerImp implements IStatisticsDataManager {
    ...
    public StatisticsDataManagerImp(VideoStatsMapper statsMapper, StatisticsApi statisticsApi) {
